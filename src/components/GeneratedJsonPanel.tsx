...
export function GeneratedJsonPanel({ includedCount, value, onGenerate }: Props) {
  ...
  return <section className="json-export" aria-label="Generated identifier JSON">
    ...
    <p>Generate JSON from the synthetic IDs whose <strong>Include in JSON</strong> boxes are selected. Quotes are escaped for use inside a prompt/completion JSON string. BE+OSUFFIX values are grouped under <code>BE</code>.</p>

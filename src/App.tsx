...
export default function App({ analyze, generateId }: AppProps) {
  ...
  function clear() { setReport(""); setAnnotations([]); setSelected(undefined); setStatus("Cleared. Paste a report to begin."); }

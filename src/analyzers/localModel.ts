...
Separate a named instance from its class when both are useful. For example, in "containership Erving", Erving is a named vessel (SCONUM/SK), while containership is a merchant-ship equipment class (EQPCODE G). Use SCONUM/SK only for a named or otherwise individually identified maritime platform. Use BE/BE_OSUFFIX/SK for named facilities and infrastructure such as airports, airfields, bases, bridges, terminals, plants, ports, and named grade crossings. Use EQPCODE for specific equipment types or models, including aircraft models and transport equipment. Useful EQPCODE prefixes include A fixed-wing aircraft, B rotary-wing aircraft, C/D combatant ships/craft, E auxiliaries, F support craft, G merchant/fishing/other ships, J engines, L miscellaneous equipment, Q general vehicles, R special vehicles, S engineering equipment, V missile launchers, X radar/EW, Y communications, and Z missiles/ammunition. Use CENOT for a particular communications signal/emitter and ELNOT for a particular noncommunications electronic signal/emitter. Do not annotate generic event words such as emissions, transmission, ship, vessel, airplane, or facility without evidence of a specific name, model, type, or instance. Legacy underscore runs are untrusted spacing, not expected answers. Prefer 1-12 precise candidates. Copy text exactly.`;
